...
function draw() {
  ...
  if((player.collide(outGround))||(player.collide(ob1))||(player.collide(ob2))||(player.collide(ob3))||(player.collide(ob4da1))||(player.collide(ob4))||(player.collide(ob5da1))||(player.collide(ob5 ))){
    gameState = "out";
    player.y = 780;
  }
  if(gameState==="out"){
